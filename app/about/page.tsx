  ...
  return (
    <div className="max-w-2xl mx-auto mt-2 mb-2 w-full h-full">
      <section className="mb-4">
        ...
        <p className="md:text-lg md:leading-5 leading-tight">
          Here&apos;s a copy of my <a href="/Aman.pdf" className="text-indigo-700 dark:text-indigo-400 underline" download>resume.</a>
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <p className="md:text-lg md:leading-5 leading-tight">
          I enjoy graphic design, philosophical literature, origami, and calligraphy. I lead the design team for my university&apos;s fine arts society. Here&apos;s some <br /><a href="/about/interests" className="text-indigo-700 dark:text-indigo-400 underline"> Stuff I Like</a>
        </p>
      </section>
      <hr className="my-2 border-border" />
      <section className="mb-4">
        ...
        <div className="flex ml-8">
          <ul className="list-disc list-inside md:text-lg md:leading-5 leading-tight">
            <li>
              I am <a href="https://github.com/aman1117" target="_blank" className="text-indigo-700 dark:text-indigo-400 underline">aman1117</a> on GitHub
            </li>
            <li>
              I am <a href="https://leetcode.com/u/aman1117/" target="_blank" className="text-indigo-700 dark:text-indigo-400 underline">aman1117</a> on Leetcode
            </li>
            <li>
              I am <a href="https://codeforces.com/profile/aman1117" target="_blank" className="text-indigo-700 dark:text-indigo-400 underline underline-offset-2">aman1117</a> on Codeforces
            </li>
            <li>
              I am <a href="https://www.linkedin.com/in/aman1117/" target="_blank" className="text-indigo-700 dark:text-indigo-400 underline">aman1117</a> on LinkedIn
            </li>
            <li>
              I am <a href="https://www.instagram.com/_aman1117_/" target="_blank" className="text-indigo-700 dark:text-indigo-400 underline underline-offset-2">_aman1117_</a> on Instagram
            </li>
          </ul>
        </div>
      </section>
